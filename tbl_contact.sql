...
--
-- Host: 127.0.0.1
-- Tempo de geração: 01-Mar-2023 às 21:08
...
CREATE TABLE `tbl_contact` (
  ...
  `assunto` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `mensagem` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

--
-- Extraindo dados da tabela `tbl_contact`
--

INSERT INTO `tbl_contact` (`nome`, `email`, `assunto`, `mensagem`) VALUES
('E', 'E', 'E', 'E'),
('adada', 'dadad', 'dadad', 'dadad'),
('adada', 'dadad', 'dadad', 'dadad'),
('dadad', 'dadad', 'dadad', 'dadad');
COMMIT;
